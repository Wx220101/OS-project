...
CFLAGS		= -m32 -I include/ -I include/sys/ -c -fno-builtin -fno-stack-protector -fno-pie -fcommon -Wall
...
buildimg :
	...
	mcopy -n -o -i $(FD) boot/loader.bin ::/loader.bin
	mcopy -n -o -i $(FD) kernel.bin ::/kernel.bin
